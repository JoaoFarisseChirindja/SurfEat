...
function function_alert() { 
    ...
    echo "<script>alert('Obrigado, a sua encomenda foi efectuada com sucesso. ');</script>"; 
	...
	header('location:login.php');
												...
												$item_total += ($item["price"]*$item["quantity"]);
													...
													$SQL="insert into users_orders(u_id,title,quantity,price) values('".$_SESSION["user_id"]."','".$item["title"]."','".$item["quantity"]."','".$item["price"]."')";
                                                        ...
                                                        unset($item["quantity"]);
                                                        unset($item["price"]);
														$success = "Obrigado, a sua encomenda foi efectuada com sucesso. ";
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item "><span>2</span><a href="#">Escolha a sua comida favorita</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                        ...
                                        <div class="cart-totals-fields">
											...
											<tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-color"><strong> <?php echo "MT ".$item_total; ?></strong></td>
                                                    </tr>
                                                </tbody>
                                    ...
                                    <div class="payment-option">
                                        <ul class=" list-unstyled">
                                            <li>
                                                <label class="custom-control custom-radio  m-b-20">
                                                    <input name="mod" id="radioStacked1" checked value="COD" type="radio" class="custom-control-input"> <span class="custom-control-indicator"></span> <span class="custom-control-description">Dinheiro na entrega</span>
                                                </label>
                                            </li>
                                            <li>
                                        ...
                                        <p class="text-xs-center"> <input type="submit" onclick="return confirm('Confirme a encomenda por favor');" name="submit"  class="btn btn-success btn-block" value="Encomendar agora!"> </p>
                                    </div>
									</form>
                                </div>
                            </div>
