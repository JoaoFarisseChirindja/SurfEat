            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item active"><span>1</span><a href="#">Escolha uma Sucursal</a></li>
                        <li class="col-xs-12 col-sm-4 link-item"><span>2</span><a href="#">Escolha o seu prato favorito!</a></li>
                        <li class="col-xs-12 col-sm-4 link-item"><span>3</span><a href="#">E nós entregamos!</a></li>
                    </ul>
                </div>
            </div>
														 ...
														 <div class="col-sm-12 col-md-12 col-lg-4 text-xs-center">
																<div class="right-content bg-white">
																	<div class="right-review">
																		...
																		<a href="dishes.php?res_id='.$rows['rs_id'].'" class="btn btn-purple">Ver menu</a> </div>
																</div>
																<!-- end:right info -->
															</div>';
										  }
