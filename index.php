...
<head>
    ...
    <link rel="icon" href="#">
    <title>Home</title>
    <link href="./OnlineFood-PHP/bootstrap-icons/bootstrap-icons.css">
    ...
    <header class="header-scroll top-header headrom">
      ...
      <div class="header-bottom">
        <div class="header-bottom-left">
          <h1>SurfEat</h1>
          <p>
        "Transforme sua experiência gastronômica no Surfjat com 
        Surfeat: a maneira mais inteligente e saborosa de se conectar, pedir e saborear!"</p>
        </div>
        <div class="header-bottom-right">
          <img src="hero.png" alt="Plato girando" id="spinning-plate">
        </div>
      </div>
    </div>
    ...
    <section class="hero bg-image" data-image-src="images/img/pimg.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>Pedidos de entrega e retirada </h1>
                ...
                <div class="steps">
                    <div class="step-item step1">
                        ...
                        <h4><span style="color:white;">1. </span>Escolha a sucursal mais proxima</h4>
                    </div>
                    ...
                    <div class="step-item step2">
                        ...
                        <h4><span style="color:white;">2. </span>Escolha um prato</h4>
                    </div>
                    ...
                    <div class="step-item step3">
                        ...
                        <h4><span style="color:white;">3. </span>E nós entregamos!</h4>
                    </div>
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                ...
                <p class="lead">A maneira mais fácil de pedir sua comida favorita entre esses 6 melhores pratos</p>
            </div>
            <div class="row">
                <?php
                    ...
                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="price-btn-block"> <span class="price">MT' . $r['price'] . '</span> <a href="dishes.php?res_id=' . $r['rs_id'] . '" class="btn theme-btn-dash pull-right">Encomendar</a> </div>
                                                </div>
        ...
        <div class="container">
                ...
                <div class="row how-it-works-solution">
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <h3>Escolha a sucursal mais proxima!</h3>
                                <p>Nós cobrimos o seu com menus de uma variedade de restaurantes de entrega online.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                        <div class="step step-2">
                            ...
                            <p>Te damos cobertura com uma variedade de restaurantes de entrega online.</p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                        <div class="step step-3">
                            ...
                            <p>Receba sua comida! E aproveite sua refeição! </p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12 text-center">
                    <p class="pay-info">Pagamento depois da entrega </p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="bottom-footer">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-4 address color-gray">
                        ...
                        <h5>Telefone: +258 85 017 3428 </a></h5>
                    </div>
