                   ...
                   <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Sucursal</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_restaurant.php">Todas as sucursais</a></li>
					 ...
					 <div class="container-fluid">
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Adicionar categoria de Sucursal</h4>
                            </div>
											...
											<?php
												...
												$query=mysqli_query($db,$sql);
													...
													if(!mysqli_num_rows($query) > 0 )
														{
															echo '<td colspan="7"><center>Sem dados nas categorias!</center></td>';
														}
													else
														{				
