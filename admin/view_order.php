                   ...
                   <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Sucursal</span></a>
                            <ul aria-expanded="false" class="collapse">
								...
								<li><a href="add_category.php">Adicionar Categorias</a></li>
                                <li><a href="add_restaurant.php">Adicionar sucursais</a></li>
                                        ...
                                        <tbody>
                                           <?php
											...
											<tr>
												    ...
												    <td><center><?php echo $rows['username']; ?></center></td>
													   ...
													   <a href="javascript:void(0);" onClick="popUpWindow('order_update.php?form_id=<?php echo htmlentities($rows['o_id']);?>');" title="Update order">
															 <button type="button" class="btn btn-primary">Actualizar o estado</button></a>
															 </center>
											 </td>
												...
												<td><strong>Title:</strong></td>
												    <td><center><?php echo $rows['title']; ?></center></td>
													   ...
													   <a href="javascript:void(0);" onClick="popUpWindow('userprofile.php?newform_id=<?php echo htmlentities($rows['o_id']);?>');" title="Update order">
														<button type="button" class="btn btn-primary">Ver detalhes</button></a>
											...
											<tr>
												    ...
												    <td><center>MT <?php echo $rows['price']; ?></center></td>
											...
											<tr>
													...
													<?php 
																			...
																			{
																			?>
																			<td> <center><button type="button" class="btn btn-info"><span class="fa fa-bars"  aria-hidden="true" ></span> Por atualizar</button></center></td>
																		   <?php 
																			  }
																			   if($status=="in process")
																			 { ?>
																			<td>   <center><button type="button" class="btn btn-warning"><span class="fa fa-cog fa-spin"  aria-hidden="true" ></span>A caminho!</button></center></td> 
																			<?php
																				}
																			if($status=="closed")
																				{
																			?>
																			<td>  <center><button type="button" class="btn btn-primary" ><span  class="fa fa-check-circle" aria-hidden="true"></span> Entregue</button></center></td> 
																			<?php 
																			} 
																			?>
																			<?php
