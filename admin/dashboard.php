            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a href="dashboard.php"><i class="fa fa-tachometer"></i><span>Painel</span></a>
                        </li>
            ...
            <div class="col-lg-12">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">painel do administrador</h4>
                            </div>
                     <div class="row">
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from users_orders WHERE status = 'in process' ";
												$result=mysqli_query($db,$sql); 
													...
													echo $rws;?></h2>
                                    <p class="m-b-0">Pedidos em andamento</p>
                                </div>
                            </div>
                        </div>
                    </div>
